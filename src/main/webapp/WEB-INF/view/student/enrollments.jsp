        ...
        <div id="account-info" class="col-sm-11 col-md-10 col-lg-10" style="padding: 30px">
            ...
            <div class="card">
                <div class="card-header card-info">
                    Zarządzanie zapisami na przedmioty
                </div>
                <div class="card-block justify-content-md-center">
                    ...
                    <table class="table justify-content-md-center">
                        <tr>
                            <form action="enrollments" method="GET">
                                <td><b>Wyszukaj przedmiot po kodzie: </b></td>
                                <td><input type="text" class="form-control" name="code" placeholder="Kod przedmiotu"/></td>
                    ...
                    <div id="realisations" class="row justify-content-md-center table-responsive table-body" style="padding: 10px; margin-bottom: 10px">
                        ...
                        <table class="table justify-content-md-center" width="100%">
                            ...
                            <c:forEach var="subject" items="${realisations}">
                                <tr style="min-width: 100%; padding: 5px; border-bottom: 1px solid gray">
                                    ...
                                    <td class="justify-content-md-center">
                                        <div class="btn-group">
                                            ...
                                            <form name="enroll" action="enrollments" method="POST">
                                                <input type="hidden" name="code" value="${subject.realName}"/>
